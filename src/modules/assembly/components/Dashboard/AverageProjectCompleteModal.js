...
const AverageProjectCompleteModal = ({ selectedMonth, project }) => {
  ...
  projectData.map(h => {
    return activity1.push(h.actName)
  })
  ...
  const projectColumns = [
    ...
    },
    {
      ...
      key: 'actName',
      filters: activity3,
      filteredValue: filterData.actName,
      onFilter: (value, record) => record?.actName === value,
    },
    {
...
export default AverageProjectCompleteModal
