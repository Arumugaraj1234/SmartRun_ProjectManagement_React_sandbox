...
import QualityDetails from '../qtyDetails'
import NavigationTabComponent from '../../../../components/shared/NavigationTabComponent'
import DisignBase from '../qtyDesignBase'
import NavigationComponent from '../qtyNavigationComponent'
import '../../style.scss'
import './style.scss'
...
const Qtyprocess = () => {
  ...
  const fetchSubMenuList = () => {
    const returnData = SubMenuService(QtyHdrId, processDoc, tenantId)
    return returnData
  }

  useEffect(() => {
    async function onLoadFunc() {
      const response = await fetchSubMenuList(QtyHdrId, processDoc, tenantId)
  ...
  //  console.log(content,"----contenthiiii")
  ...
  return (
    <div>
      <NavigationComponent
        EntryDetailsComponent={QualityDetails}
