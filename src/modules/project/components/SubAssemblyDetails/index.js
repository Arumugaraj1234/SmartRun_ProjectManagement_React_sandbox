...
const SubAssemblyDetails = () => {
  ...
  // const updatedTableData = budgetLinkTablDtl.map(item => {
  //   return {
  //     ...item,
  //     totalValue: formValue[`allocatedQty_${item.pkseId}`] || '',
  //   }
  // })
  // console.log(updatedTableData)
  // console.log(value)
  // setSlctdElementVal(value)
  // console.log(formatReq1)
  // getBudgetLinkPopUpValues(value)
  // updateBudgetLinkPopup(formatReq1)

  // const updateBudgetLinkPopup = async e => {
  //   const response = await indentFileUpload({
  //     requestPath: 'insertSubAreaExtn',
  //     requestData: e,
  //   })
  //   const respVal = response.responseMessage
  //   console.log(respVal)
  // }
  ...
  const handleInputChange = (index, newValue, e) => {
    if (parseInt(newValue.totalQty, 10) >= parseInt(index, 10)) {
      // const totVal = parseInt(index, 10) * parseInt(newValue.perPartVal, 10);
            ...
            <div className="row form_datas">
              ...
              <div className="col-md-12">
                {/* <Form
                  form={tableform}
                  onFinish={onFinish}
                  initialValues={{ dtlList: budgetLinkTablDtl }}
                > */}
  ...
  // if (
  //   (record.dskId !== undefined && record.dskId !== '') ||
  //   (record.pkaId !== undefined && record.pkaId !== '')
  // ) {
  //   deleteExistSubAssy(record)
  // } else if (subDatas.length > 1) {
  //   const newData = [...subDatas]
  ...
  // const handleSelectSubChange = (value, index) => {
  //   const newArr = [...subDatas]
  //   newArr.map(item => {
  //     if (index.deHdrid === item.deHdrid) {
  //       return { ...item, pskId: value }
  //     }
  //     return item
  //   })
  //   index.pskId = value
  ...
  //     const updatedData = budgetLinkTablDtl.map((item, index) => ({
  //       ...item,
  //       isRetrieve: 1,
  //       isUpdate: 0,
  //     }));
  //     setBudgetLinkTablDtl(updatedData)
  //     return updatedData;
  //   }
  // }, [budgetLinkTablDtl]);
