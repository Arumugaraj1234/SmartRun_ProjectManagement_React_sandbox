...
const ProjectManualModal = ({ selectedMonth, project }) => {
  ...
  const projectColumns = [
    ...
    },
    {
      ...
      render: (text, record) => {
        ...
        // const diff=moment(record.plannedCompletedDate).diff(moment(record.plannedStartDate), 'days')
...
export default ProjectManualModal
