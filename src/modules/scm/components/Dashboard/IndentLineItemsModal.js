...
const IndentLineItemsModal = ({ selectedMonth, project, check }) => {
  ...
  const getProjectDataDtls = async () => {
    ...
    const httpresponse = await InspectionReportService({
      requestPath: 'getIndentLineItemsDrill',
      requestData: props,
    })
  ...
  const handleExportCSV = () => {
    ...
    downloadCSV(csvData, `Indent_Line_Items_Details-${currentDateTime}.csv`)
  }
...
export default IndentLineItemsModal
