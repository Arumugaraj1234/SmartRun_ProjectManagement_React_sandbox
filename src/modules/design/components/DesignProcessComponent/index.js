...
import DisignBase from '../DesignBase'
...
const Designprocess = () => {
  ...
  const fetchSubMenuList = () => {
    const returnData = SubMenuService(DesignID, processDoc, tenantId)
    return returnData
  }
  useEffect(() => {
    async function onLoadFunc() {
      const response = await fetchSubMenuList(DesignID, processDoc, tenantId)
