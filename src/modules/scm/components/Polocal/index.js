...
const Polocal = ({ rowData, onClose, calldetailapi, isView }) => {
  ...
  //   poform.getFieldValue('debitNoteReason')
  // }
  ...
  useEffect(() => {
    console.log('Selected rows:', paymentData)
  }, [paymentData])
  ...
  const getPoDetails = async () => {
    ...
    if (response?.responseData !== null && response?.responseData !== undefined) {
      ...
      poform.setFieldsValue({
        ...
        CTC: response?.responseData[0]?.ctc,
        TDC: response?.responseData[0]?.tdc,
        TDS: response?.responseData[0]?.tds,
        ...
        taxablevalue: formatValue2(response?.responseData[0]?.terminalTax || '0'),
      ...
      console.log(response?.responseData[0].isEditable)
      if (response?.responseData[0].isEditable === '1') {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Form.Item
          name={`gst_${record.poDtlId}`}
          initialValue={record.poGst != null && record.poGst !== '' ? Number(record.poGst) : '-'}
        >
          {/* <Form.Item name={`gst_${record.poDtlId}`} initialValue={-12}> */}
          <Select
            style={{ width: '150px' }}
            options={[
              { value: 0, label: '0' },
  ...
  const onLoadCalculation = data => {
    ...
    poform.setFieldsValue({
      ...
      taxablevalue: TerminalTax.toLocaleString('en-IN'),
    })
  }
  console.log('CustomFormItem')
  ...
  const debitNoteSubmit = async () => {
    ...
    console.log(valueForDebitNote, 'Value for Debit note')
  ...
  const handleinsert = async () => {
    return new Promise((resolve, reject) => {
      ...
      console.log('payement term', paymenttermsWithoutLast)
      const payload = {
        poId: projectList[0].poId,
        ...
        guarantee: projectList[0].guarantee,
        ...
        terminalTax: removeCommas(formvalues.taxablevalue) || '0',
        ...
        qap: projectList[0].qap || '0',
        gtc: projectList[0].gtc || '0',
        ...
        ctc: formvalues.CTC || '0',
        tdc: formvalues.TDC || '0',
        tds: formvalues.TDS || '0',
    ...
    <div className="mt-3">
      <Skeleton loading={isLoading} active>
        <Spin spinning={isSubmitting} size="large" tip="Please wait...">
          <Card title="Purchase Order - Domestic" className="customize">
            <Form
              layout="horizontal"
                ...
                <div className="row costom-form-body">
                  ...
                  <div className="col-md-5">
                    ...
                    {/* <CustomFormItem
                      ...
                      label={
                        <span style={{ textAlign: 'center' }}>
                          Transit Insurance <span style={{ color: 'red' }}> *</span>
                        </span>
                      }
                    /> */}
                    <Form.Item
                ...
                <div className="costom-form-body mt-3">
                  <div className="col-md-5">
                    <div className="custom-form-container">
                      ...
                      <CustomFormItem
                        ...
                        label={
                          <span style={{ textAlign: 'center' }}>
                            2. DWGS <span style={{ color: 'red' }}> *</span>
                          </span>
                        }
                        type="text"
                  ...
                  <div className="col-md-5 custom-form-container">
                    <div className="amount_words">
                      ...
                      >
                        <TextArea
                          ...
                          disabled
                          style={
                            isFieldValueChanged('amountinwords')
                              ? HighlightStyle
                              : { width: '100%' }
                          }
                        />
                    ...
                    {/* <CustomFormItem
                      onChange={amountonchange}
                      name="gst"
                      value={poform.getFieldValue('gst')}
                ...
                {docStatus &&
                  ...
                  docStatus[0].currSequence !== '3' && (
                    <ButtonComponent
                      ...
                      disable={isSubmitting}
                      onClick={() => {
                        addprevRemarksSubmit(docStatus[0].cancelSeq)
                      }}
                    />
                  )}
                <Popuptable
        ...
        {paymentLoading && (
          <PaymentTermsPopUp
            ...
            po={poform.getFieldValue('taxablevalue')}
            gst={(
              Number((poform.getFieldValue('gst') || 0).toString().replace(/,/g, '')) * 2
            ).toString()}
            igst={poform.getFieldValue('IGST')}
            poForm={poform.getFieldsValue()}
          />
        )}
      </Skeleton>
    </div>
