    ...
    <div className="d-flex flex-wrap">
      <div className="mb-3 mr-auto">
        ...
        <div className="d-flex align-items-start">
          <div className="kit__utils__avatar kit__utils__avatar--size64 mr-2">
            <img src="resources/images/avatars/4.jpg" alt="Mary Stanform" />
          </div>
          <div className="kit__utils__avatar kit__utils__avatar--size46">
            <img src="resources/images/avatars/4.jpg" alt="Mary Stanform" />
      ...
      <div>
        ...
        <div className="d-flex align-items-start">
          <div className="kit__utils__avatar kit__utils__avatar--size64 kit__utils__avatar--rounded mr-2">
            <img src="resources/images/avatars/4.jpg" alt="Mary Stanform" />
          </div>
          <div className="kit__utils__avatar kit__utils__avatar--size46 kit__utils__avatar--rounded">
            <img src="resources/images/avatars/4.jpg" alt="Mary Stanform" />
